...
const d = {
...
}, T = (s) => [d.prefix, s, d.suffix].filter((e) => e && e.length > 0).join("-"), X = (s) => {
  ...
  getGoogleAnalyticsName: (s) => s || T(d.googleAnalytics),
  getPrecacheName: (s) => s || T(d.precache),
  getPrefix: () => d.prefix,
  getRuntimeName: (s) => s || T(d.runtime),
  getSuffix: () => d.suffix
};
function S(s, e) {
  const t = e();
...
const G = /* @__PURE__ */ new WeakMap(), N = /* @__PURE__ */ new WeakMap(), Q = /* @__PURE__ */ new WeakMap(), U = /* @__PURE__ */ new WeakMap(), M = /* @__PURE__ */ new WeakMap();
function Te(s) {
...
function ke(s) {
  return s === IDBDatabase.prototype.transaction && !("objectStoreNames" in IDBTransaction.prototype) ? function(e, ...t) {
    const n = s.call(k(this), e, ...t);
    return Q.set(n, e.sort ? e.sort() : [e]), f(n);
  } : De().includes(s) ? function(...e) {
    return s.apply(k(this), e), f(G.get(this));
  } : function(...e) {
    return f(s.apply(k(this), e));
  };
}
function Le(s) {
  return typeof s == "function" ? ke(s) : (s instanceof IDBTransaction && Pe(s), xe(s, Ee()) ? new Proxy(s, I) : s);
}
function f(s) {
...
const Me = ["get", "getKey", "getAll", "getAllKeys", "count"], Ae = ["put", "add", "delete", "clear"], L = /* @__PURE__ */ new Map();
function B(s, e) {
  if (!(s instanceof IDBDatabase && !(e in s) && typeof e == "string"))
    return;
  if (L.get(e))
    return L.get(e);
  const t = e.replace(/FromIndex$/, ""), n = e !== t, a = Ae.includes(t);
  if (
...
class Se {
   ...
   */
  async getDb() {
    return this._db || (this._db = await Ne(Ke, 1, {
...
class A {
  ...
  _getCacheExpiration(e) {
    ...
    return t || (t = new Oe(e, this._config), this._cacheExpirations.set(e, t)), t;
  }
  /**
...
_e([{"revision":null,"url":"workbox-c332bc95.js"},{"revision":"b2d23336786f4889319670c4ebc13033","url":"manifest.json"}]);
D(
