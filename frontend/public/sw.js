...
// Remove the message listener for SKIP_WAITING
/*
...
// Call skipWaiting directly (like in raven)
self.skipWaiting();

// Claim clients immediately (like in raven)
clientsClaim();

console.log("CRM Service Worker Initialized (Raven Style)"); 